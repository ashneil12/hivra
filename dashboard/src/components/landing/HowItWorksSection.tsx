...
export default function HowItWorksSection() {
  ...
  return <section id="how-it-works" className={`${styles.section} ${styles.stepsSection}`}>
    ...
    <div className={styles.sectionEnding}><p>{section.footer}</p><Link href={english ? "/dashboard/launch?start=1" : PUBLIC_START_HREF} className={styles.textLink}>{section.cta}<ArrowRight size={18} /></Link></div>
  </section>;
}
