  ...
  return <section id="tokenomics" className={styles.economy} aria-labelledby="tokenomics-heading">
    ...
    <div className={styles.accessMigration}>
      ...
      <article className={styles.migration}>
        ...
        <p>The proposal is $HIVRA on Base, launched through Bankr. An active claim would sell old tokens into their pool and use the ETH proceeds to buy $HIVRA in the new pool.</p>
