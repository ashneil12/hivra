...
export const REMOTE_DESKTOP_SESSION_REVISIONS: readonly string[] = [...new Set([
  ...
  // The previous sealed broker (2026.09.15.2, broker.cjs 6e056fef) keeps the
  // same session protocol; only Omarchy opted into the removed fixed-arrow
  // browser override. Every revision either repository issued sessions for
  // stays admitted so retained guests are not interrupted.
...
export const REMOTE_DESKTOP_COMPATIBILITY = {
  ...
  "6e66475cc695c033c9b2ed568e5ce0cecd3a3b7cbcb75682eb40e59f3020e96d": { version: "2026.09.15.2", recipe: "symlinks-v3" },
