  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "On Hivra, skills work identically to self-hosted — stored in the instance's persistent volume, surviving container restarts. The self-creation loop is particularly useful here: an instance you have been using for six months accumulates a skill library tuned to your exact working patterns. That library lives on the instance's disk and is included in profile exports.",
      ],
    },
  ],
  faqs: [
