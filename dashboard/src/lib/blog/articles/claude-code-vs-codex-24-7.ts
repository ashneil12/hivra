...
export const article: BlogArticle = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: `Yes, as long as both boxes fit in the plan's compute pool. On Hivra, the ${LARGER_PLAN_PRICE}/month plan (${LARGER_PLAN_SIZE}) fits one Claude Code box and one Codex box with their browsers on, each on its own private VM with its own login.`,
    },
    {
    ...
    },
    {
      ...
      a: "The run in progress stops with a usage-limit error. The box, its files, and the session history stay, so you resume the session once the window resets. It is an argument for running both agents: when one subscription hits its limit, the other box can take the next task.",
    },
    {
