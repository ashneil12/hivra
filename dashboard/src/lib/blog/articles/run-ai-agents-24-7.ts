...
export const article: BlogArticle = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "On a Linux box, run it as a systemd service with Restart=always and a RestartSec delay, plus MemoryMax to contain leaks. Also cover the quiet failures: rotate logs so the disk never fills, probe real behavior rather than just the process ID, and alert on task failure rate to catch expired credentials.",
    },
    {
