...
export const article: BlogArticle = {
  ...
  intro:
    "BYO API key means you supply your own AI provider credentials. Your requests go directly from your agent to the model provider, and Hivra never sees your usage or handles your billing.",
  sections: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "This does not mean the data is private from the provider. Anthropic, OpenAI, and others have their own data handling policies, and API usage may be used for model improvement depending on your account settings. What it does mean: Hivra cannot read your agent's conversations, cannot log your task data, and has no access to your content. We see server metrics — CPU, memory, uptime — not content.",
      ],
    },
  ],
  faqs: [
