 ...
 *
 *   contractAddress  the $HIVRA ERC-20 on Base, as published (checksummed or
 *                    lowercase). Read it from the Bankr launch, then confirm it
 *                    on BaseScan.
 ...
 *   activatesAt      ISO-8601 UTC instant $HIVRA goes live. Users with a
 ...
 * the build on a half-filled or malformed block, and at runtime a malformed
 * block keeps $HIVRA dormant.
 *
