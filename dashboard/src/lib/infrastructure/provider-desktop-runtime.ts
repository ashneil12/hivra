...
export function buildProviderWorkspaceRuntimeProbe(input: ProviderWorkspaceRuntimeProbe): string {
  if (!["2026.09.05.9", "2026.09.05.10", "2026.09.06.1", "2026.09.06.2", "2026.09.06.3", "2026.09.06.4", "2026.09.07.1", "2026.09.08.1", "2026.09.08.2", "2026.09.08.3", "2026.09.15.1", "2026.09.15.2", "2026.09.22.1"].includes(checked(input).identity.bundle.provisionerVersion)) throw new Error("Workspace protocol unavailable");
...
try:
 ...
 def workspace_observe(services):
  ...
  if preparation['controlOrigin']!=WORKSPACE_CONTROL or len(WORKSPACE_FILES)!=${["2026.09.06.1", "2026.09.06.2", "2026.09.06.3", "2026.09.06.4", "2026.09.07.1", "2026.09.08.1", "2026.09.08.2", "2026.09.08.3", "2026.09.15.1", "2026.09.15.2", "2026.09.22.1"].includes(expected.identity.bundle.provisionerVersion) ? 11 : 10}: reject()
...
export function parseProviderWorkspaceRuntimeReceipt(output: string, input: ProviderWorkspaceRuntimeProbe) {
  try {
    ...
    if (!["2026.09.05.9", "2026.09.05.10", "2026.09.06.1", "2026.09.06.2", "2026.09.06.3", "2026.09.06.4", "2026.09.07.1", "2026.09.08.1", "2026.09.08.2", "2026.09.08.3", "2026.09.15.1", "2026.09.15.2", "2026.09.22.1"].includes(expected.identity.bundle.provisionerVersion) || Buffer.byteLength(output) > 8192
