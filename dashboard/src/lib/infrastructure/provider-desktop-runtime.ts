...
export const PROVIDER_WORKSPACE_PROTOCOL_VERSIONS = ["2026.09.05.9", "2026.09.05.10", "2026.09.06.1", "2026.09.06.2", "2026.09.06.3", "2026.09.06.4", "2026.09.07.1", "2026.09.08.1", "2026.09.08.2", "2026.09.08.3", "2026.09.15.1", "2026.09.15.2", "2026.09.21.1", "2026.09.22.1", "2026.09.22.2", "2026.09.24.1", "2026.09.24.3"] as const;
...
try:
 ...
 def workspace_observe(services):
  ...
  if preparation['controlOrigin']!=WORKSPACE_CONTROL or len(WORKSPACE_FILES)!=${["2026.09.24.1", "2026.09.24.3"].includes(expected.identity.bundle.provisionerVersion) ? 12 : ["2026.09.06.1", "2026.09.06.2", "2026.09.06.3", "2026.09.06.4", "2026.09.07.1", "2026.09.08.1", "2026.09.08.2", "2026.09.08.3", "2026.09.15.1", "2026.09.15.2", "2026.09.21.1", "2026.09.22.1", "2026.09.22.2"].includes(expected.identity.bundle.provisionerVersion) ? 11 : 10}: reject()
