...
function identity(version: "2026.09.05.6" | "2026.09.05.7" | "2026.09.05.8" | "2026.09.05.9" | "2026.09.05.10" | "2026.09.06.1" | "2026.09.06.2" | "2026.09.06.3" | "2026.09.06.4" | "2026.09.07.1" | "2026.09.08.1" | "2026.09.08.2" | "2026.09.08.3" | "2026.09.15.1" | "2026.09.15.2" | "2026.09.21.1" | "2026.09.22.1" | "2026.09.22.2", bundle: string) { return z.object({ version: z.literal(3), agentId: Uuid, operationId: Uuid,
...
export function buildProviderDesktopWorkerPlan(input: ProviderDesktopWorkerInput, clock: ProviderGuestClock) {
  try {
    ...
    const identity = (input.action === "start" ? CurrentIdentity : Identity).parse(input.action === "start"
      ...
      : input.identity);
    const maxRunMs = [VERSION, "2026.09.22.1", "2026.09.21.1", "2026.09.15.2", "2026.09.06.3", "2026.09.06.2", "2026.09.06.1", "2026.09.05.10", "2026.09.05.9", "2026.09.05.8"].includes(identity.bundle.provisionerVersion) ? 1_200_000 : 480_000;
