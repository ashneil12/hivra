-- Admit the 2026.09.01.8 provider bundle. DeepSeek's typed native document is
-- also accepted by Proxmox, while public catalog admission remains separate.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.01.5','2026.09.01.6','2026.09.01.7','2026.09.01.8'),false)
