-- Admit the 2026.09.02.8 provider bundle for its existing provider runtimes.
-- Linux Desktop remains Proxmox-only; the provider worker and native cleanup
-- closure are unchanged and republished under the new immutable bundle.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.02.6','2026.09.02.7','2026.09.02.8'),false)
