-- Admit the 2026.09.02.7 provider bundle. Runtime behavior and the native
-- cleanup closure are unchanged; the source-only provenance identity and
-- worker version are republished under a new immutable bundle.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.02.6','2026.09.02.7'),false)
