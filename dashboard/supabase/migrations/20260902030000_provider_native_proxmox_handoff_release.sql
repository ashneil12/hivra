-- Admit the 2026.09.02.1 provider bundle. The provider worker protocol and
-- native cleanup closure are unchanged; the Proxmox launcher now hands native
-- code to the guest through a root-only immutable source directory.
