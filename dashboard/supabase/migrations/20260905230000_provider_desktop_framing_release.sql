-- Admit the current 2026.09.05.7 bundle and retain exact historical identities.
-- Only release identities change; runtime availability, ownership, setup leases,
-- and native cleanup authority remain unchanged.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.02.1','2026.09.02.2','2026.09.02.3','2026.09.02.4','2026.09.02.5',
      '2026.09.02.6','2026.09.02.7','2026.09.02.8',
      '2026.09.03.1','2026.09.03.2','2026.09.04.1','2026.09.04.2',
      '2026.09.04.3','2026.09.04.4','2026.09.05.1','2026.09.05.2','2026.09.05.3','2026.09.05.4','2026.09.05.5','2026.09.05.6','2026.09.05.7'),false)
...
create or replace function public.hivra_provider_native_identity_valid(
  ...
  select (jsonb_typeof(p_identity)='object'
    ...
    and (
      ...
      or (p_identity->'bundle'->>'bundleSha256'='72df19a49b746d09b73d8569512707d406c08ccf847a6896991a256a741642e3' and p_identity->'bundle'->>'provisionerVersion'='2026.09.02.4')
      or (p_identity->'bundle'->>'bundleSha256'='7e91cd275b0af9c7cefe7be8345a288d503873e06858460cb7ef0be14c009944' and p_identity->'bundle'->>'provisionerVersion'='2026.09.02.5')
      or (p_identity->'bundle'->>'bundleSha256'='98a08c2806a359533a7fdd9768b238bdb4c6647aaa46f48fd939aef00a02f2d2' and p_identity->'bundle'->>'provisionerVersion'='2026.09.02.6')
      or (p_identity->'bundle'->>'bundleSha256'='4651a9d5d96cbc43b32462c1ff4c149db22a547e5c571f25feeb1f2c761b35c0' and p_identity->'bundle'->>'provisionerVersion'='2026.09.02.7')
      or (p_identity->'bundle'->>'bundleSha256'='1b76e0a91dc9191319c8bfd519114d12934e75b89378a84113cb12d49667b999' and p_identity->'bundle'->>'provisionerVersion'='2026.09.02.8')
      or (p_identity->'bundle'->>'bundleSha256'='465b0c04f930f1a33a231cb1473df3333c3344c849c561aebbef2c5ff502b499' and p_identity->'bundle'->>'provisionerVersion'='2026.09.03.1')
      or (p_identity->'bundle'->>'bundleSha256'='381ba2ebcd9e47aa9f16df134a090f5268caee93972c1704c7be5e9086d22215' and p_identity->'bundle'->>'provisionerVersion'='2026.09.03.2')
      or (p_identity->'bundle'->>'bundleSha256'='947ade5139187a4dc4116378b16387c5cda847639900cd397388ea62a0930778' and p_identity->'bundle'->>'provisionerVersion'='2026.09.04.1')
      or (p_identity->'bundle'->>'bundleSha256'='b758765fd8de28fe3fc2c0b6aa4029579c4616ab110686778e4a814bc646ce87' and p_identity->'bundle'->>'provisionerVersion'='2026.09.04.2')
      or (p_identity->'bundle'->>'bundleSha256'='5d91ff037a175eefedc0ed6def31ebe51f43cc212789e6720576356edd6527b4' and p_identity->'bundle'->>'provisionerVersion'='2026.09.04.3')
      or (p_identity->'bundle'->>'bundleSha256'='b9ae70bf6469b3c0c726616f7103d7ab809730ab84726a0b7a4a37b2680622a6' and p_identity->'bundle'->>'provisionerVersion'='2026.09.04.4')
      or (p_identity->'bundle'->>'bundleSha256'='38d91e8f2077f0044beaec57d1846943379a1291225cc2992e71064f63364c93' and p_identity->'bundle'->>'provisionerVersion'='2026.09.05.1')
      or (p_identity->'bundle'->>'bundleSha256'='391a7ea9b299c01b65b2765824760af3d6a813aa2ae44f129dd9ffb660041b41' and p_identity->'bundle'->>'provisionerVersion'='2026.09.05.2')
...
-- Retain the exact .05.6 cleanup identity; only add the sealed .05.7 pair.
create or replace function public.hivra_provider_desktop_identity_valid(p_identity jsonb,p_agent_id uuid,p_operation_id uuid)
returns boolean language sql immutable security invoker set search_path=public,pg_temp as $$
  select (jsonb_typeof(p_identity)='object'
