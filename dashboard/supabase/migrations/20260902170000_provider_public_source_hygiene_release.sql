-- Admit the 2026.09.02.6 provider bundle. Runtime behavior and the native
-- cleanup closure are unchanged; source-safe network defaults and worker
-- identity are republished under a new immutable bundle.
