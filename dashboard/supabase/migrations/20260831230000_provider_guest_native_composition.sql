-- Admit the private native guest composition revision; preserve old immutable bundles.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in ('2026.08.28.1','2026.08.28.2','2026.08.28.3','2026.08.28.4','2026.08.29.1','2026.08.29.2','2026.08.29.3','2026.08.29.4','2026.08.29.5','2026.08.30.1','2026.08.30.2','2026.08.31.1','2026.08.31.2'),false)
