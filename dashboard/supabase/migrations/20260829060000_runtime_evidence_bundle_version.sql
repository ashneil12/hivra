-- Admit the reviewed installed SBOM and notice-manifest release for newly
-- prepared provider computers without rewriting any installed computer.
-- Previous exact bundle versions remain valid for their original operations.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in ('2026.08.28.1','2026.08.28.2','2026.08.28.3','2026.08.28.4','2026.08.29.1','2026.08.29.2','2026.08.29.3','2026.08.29.4'),false)
