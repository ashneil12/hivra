-- Admit the 2026.09.02.4 provider bundle. The provider worker protocol and
-- native cleanup closure are unchanged; operation-scoped cloud-init vendor
-- data now installs the QGA prerequisite before guest SSH identity attestation.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.02.1','2026.09.02.2','2026.09.02.3','2026.09.02.4'),false)
