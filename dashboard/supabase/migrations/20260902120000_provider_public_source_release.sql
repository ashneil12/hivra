-- Admit the 2026.09.02.5 provider bundle. Runtime behavior, worker protocol,
-- and native cleanup closure are unchanged; only public documentation
-- identities changed.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.02.1','2026.09.02.2','2026.09.02.3','2026.09.02.4','2026.09.02.5'),false)
