-- Admit the 2026.09.01.1 provider bundle without changing the native v2 wire
-- protocol or enabling a new catalog runtime. Historical identities remain
-- valid only against their immutable bundle digests.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.08.31.4','2026.09.01.1'),false)
