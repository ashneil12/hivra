-- Admit the reviewed 2026.09.15.1, 2026.09.15.2, 2026.09.21.1, 2026.09.22.1 and
-- 2026.09.22.2 provider bundles without invalidating existing computers. Those releases shipped
...
-- provider-native-worker.ts (2026.09.21.1 onward computed from their manifests).
do $migration$
...
begin
  for signature, anchor, addition in select * from (values
    ('public.admit_prepared_provider_computer(text,uuid,bigint,uuid,uuid,text,uuid,uuid,jsonb)',
     ...
     '''2026.09.08.2'',''2026.09.08.3'',''2026.09.15.1'',''2026.09.15.2'',''2026.09.21.1'',''2026.09.22.1'',''2026.09.22.2'''),
