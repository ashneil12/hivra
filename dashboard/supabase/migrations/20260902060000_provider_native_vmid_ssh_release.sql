-- Admit the 2026.09.02.2 provider bundle. The provider worker protocol and
-- native cleanup closure are unchanged; the Proxmox launcher now binds every
-- guest SSH/SCP channel to the exact VMID-attested Ed25519 host key.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.02.1','2026.09.02.2'),false)
