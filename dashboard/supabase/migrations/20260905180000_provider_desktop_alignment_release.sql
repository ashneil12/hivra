-- Admit the current 2026.09.05.5 bundle and retain exact historical identities.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.04.3','2026.09.04.4','2026.09.05.1','2026.09.05.2','2026.09.05.3','2026.09.05.4','2026.09.05.5'),false)
