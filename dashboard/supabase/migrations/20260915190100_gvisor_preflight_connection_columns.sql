-- The live infrastructure_connections schema has no preflight_started_at
-- column. Replace the already-applied gVisor commit function so successful
-- preflights clear only the lease columns that the base schema defines. The
-- validation, ownership, revision, identity, and rebind fences remain intact.
...
begin
  ...
  update public.infrastructure_connections set status='ready',last_checked_at=p_checked_at,last_error_code=null,
    preflight_run_id=null,preflight_lease_expires_at=null
