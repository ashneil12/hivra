-- Admit the 2026.09.01.4 provider bundle. The native v2 wire contract remains
-- unchanged; historical identities stay bound to their immutable digests.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.08.31.4','2026.09.01.1','2026.09.01.2','2026.09.01.3','2026.09.01.4'),false)
