-- Admit the 2026.09.01.9 provider bundle. The remote desktop wrapper now
-- emits bounded browser input-to-changed-frame telemetry; catalog admission
-- and physical input-to-photon claims remain separate.
...
begin
  ...
  if not found or t.provider_retired_at is not null or t.last_preflight_at is null
    ...
    or not coalesce(t.capabilities#>>'{provisioner,version}' in (
      ...
      '2026.09.01.5','2026.09.01.6','2026.09.01.7','2026.09.01.8','2026.09.01.9'),false)
