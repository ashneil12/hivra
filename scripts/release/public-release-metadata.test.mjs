...
test('every third-party GitHub Action is pinned to an immutable commit', () => {
  ...
  // 17: Dashboard CI's parallel jobs each pin checkout and setup-node.
  assert.equal(actionCount, 17, 'review the complete workflow action inventory when it changes');
});
